...
//    protected Map<String, MetadataFactory<?, ? extends Metadata<?>>> objectMetadataFactories = new HashMap<String, MetadataFactory<?, ? extends Metadata<?>>>();
